...
```
$ docker image tag store l00162972/store
$ docker push l00162972/store
$ docker image tag invoice l00162972/invoice
$ docker push l00162972/invoice
$ docker image tag notification l00162972/notification
$ docker push l00162972/notification
$ docker image tag product l00162972/product
$ docker push l00162972/product
```
