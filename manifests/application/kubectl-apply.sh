...
logSummary() {
    echo ""
        ...
        echo "Gateway - http://store.jhipster.34.142.93.235.nip.io"
        echo "Zipkin - http://zipkin.istio-system.34.142.93.235.nip.io"
        echo "Grafana - http://grafana.istio-system.34.142.93.235.nip.io"
        echo "Kiali - http://kiali.istio-system.34.142.93.235.nip.io"
        echo "#####################################################"
}
